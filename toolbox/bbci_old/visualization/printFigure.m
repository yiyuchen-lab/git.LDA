...
opt= set_defaults(opt, 'paperSize','auto', ...
                       ...
                       'device', 'epsc2', ...
                       'folder', EEG_FIG_DIR, ...
                       'print_axis_background', 0, ...
                       'print_figure_background', 0, ...
                       'prefix', '', ...
                       'resolution', [],...
                       'renderer','painters',...
                       'embed', 1, ...
...
if opt.print_axis_background,
  if ~opt.print_figure_background,
    memo_figure_background= get(gcf, 'Color');
    set(gcf, 'Color',[1 1 1]);
  end
...
if opt.print_axis_background && ~opt.print_figure_background,
  set(gcf, 'Color', memo_figure_background);
end
